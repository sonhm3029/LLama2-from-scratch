...
def precompute_theta_pos_frequencies(head_dim: int, seq_len: int, device: str, theta: float = 10000.0):
    # As written in the paper, the dimension of the mebđing must be even
    ...
    # (Seq_len, Head_diim / 2) -> (Seq_len, Head_dim / 2)
...
class SelfAttention(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        # Indicates how many times the heads of Key and Values should be repeated to match the head of Queries
    ...
    def forward(self, x: torch.Tensor, start_pos: int, freqs_complex: torch.Tensor):
        ...
        # replace the entry in the cache of this token
        ...
        # (B, H_Q, Head_dim) -> (B, 1, H_Q, Head_dim) -> (B, 1, DIm)
